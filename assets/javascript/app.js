$(document).on('ready', function() {
	// Links to Firebase
	var database = new Firebase("https://rps2016-7cea3.firebaseio.com/");
	var presenceRef = new Firebase('https://rps2016-7cea3.firebaseio.com/.info/connected');
	var playersRef = new Firebase('https://rps2016-7cea3.firebaseio.com//playersRef');
	var turnRef = new Firebase('https://rps2016-7cea3.firebaseio.com/turn');
	var chatRef = new Firebase('https://rps2016-7cea3.firebaseio.com/chat');
		...
		listeners: function() {
			...
			database.on("value", function(snapshot) {
				...
				if (turnVal !== null && player == undefined) {
					var wrapper = $('.wrapper');
					var $img = $('<img>').attr('src',"images/image.jpg);
